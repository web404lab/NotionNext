...
const BLOG = {
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '不积跬步，无以至千里,不积小流，无以成江海',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '蜗白和痕璃', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '蜗白和痕璃的知识库', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'u.think369.cn', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客，高中学习资料,高考,历史,知识库', // 网站关键词 英文逗号隔开
